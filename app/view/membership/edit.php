...
<head>
    ...
    <title>Edit Membership - Dashboard</title>
            ...
            <div class="col-md-10">
                <div class="card">
                    <div class="card-header">
                        <h5><i class="fas fa-edit me-2"></i>Edit Membership</h5>
                    </div>
                    <div class="card-body">
                        <?php if (!empty($error)): ?>
                        ...
                        <form method="POST" id="membershipForm">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" value="<?php echo htmlspecialchars($membership['member_identifier']); ?>" readonly>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="label" name="label" value="<?php echo htmlspecialchars($membership['label'] ?? ''); ?>">
                            </div>
                            <hr>
